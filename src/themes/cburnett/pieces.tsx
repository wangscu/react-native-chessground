...
const WhiteKing: React.FC<{ size: number }> = React.memo(({ size }) => (
...
const WhiteQueen: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <Path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z" strokeLinecap="butt" />
...
const WhiteRook: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const WhiteBishop: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const WhiteKnight: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const WhitePawn: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
...
const BlackKing: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const BlackQueen: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <Path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z" fill="#000" strokeLinecap="butt" />
...
const BlackRook: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const BlackBishop: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const BlackKnight: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
    <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
const BlackPawn: React.FC<{ size: number }> = React.memo(({ size }) => (
  <Svg width={size} height={size} viewBox={viewBox}>
...
export const cburnettPieces: Record<string, React.FC<{ size: number }>> = {
  wK: WhiteKing,
  wQ: WhiteQueen,
  wR: WhiteRook,
  wB: WhiteBishop,
